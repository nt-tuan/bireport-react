...
export const KhachhangSelect = (props: Props) => {
  ...
  const handleInputChange = (value: string, meta: InputActionMeta) => {
    if (meta.action === "input-change") getDMKhachhang(value).then(setOptions);
  };
  return (
